...
function Awards() {
    return ( 
        ...
        <h1 className="text-center m-auto">We pioneered the discount broking model in India. <br/>
        Now, we are breaking ground with our technology.</h1>
        </div>
        <div className="row p-2 mt-5 border-top text-muted" style={{fontSize : "1.1em", lineHeight: '1.8'}}>
        ...
        <p>And yet, we are always up to something new every day. Catch up on the latest updates on our blogor see what the media is saying about us.</p>
        </div>
        </div>
        </div>
     );
